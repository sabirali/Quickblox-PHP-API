<?php
// By Sabirali Kharodiya PHP developer(kharodiyasabirali@gmail.com)
include 'config.php';
...
function deleteUsersById($token,$id) {
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL, QB_API_ENDPOINT.'users/'.$id.'json');
        curl_setopt($curl, CURLOPT_CUSTOMREQUEST, DELETE_USER);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
